...
const initialNotifications = [
  {
    id: 1,
    message: "Good morning, you have a visitor John Doe. They checked-in at 8:30 am and entry was approved by Officer Brian.",
  ...
  {
    id: 2,
    message: "Good morning, you have a visitor Jane Smith. They checked-in at 9:10 am and entry was approved by Officer Brian.",
  ...
  {
    id: 3,
    message: "Good morning, you have a visitor Alex Lee. They checked-in at 11:00 am and entry was approved by Officer Brian.",
...
export default function HostNotifications() {
  ...
  const [filter, setFilter] = useState("all"); // or "unread"
  const [search, setSearch] = useState("");

  // Filter by search and read/unread
  ...
  // Mark as read when user clicks an unread notification
  const markAsRead = (id) => {
  ...
  return (
    <div className="host-notifications-wrapper">
      ...
      <div className="host-notification-list">
        {filtered.length === 0 && (
          <div className="host-notifications-empty">No notifications found.</div>
        )}
        {filtered.map((n) => (
          <div
            className={
          ...
          >
            <div className="host-notification-msg">
              {n.message}
              {n.isUnread && (
                <span className="host-notification-unread-dot" title="Unread"></span>
              )}
            </div>
